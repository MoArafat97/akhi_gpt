...
const _fullText = "I CREATED THIS APP FOR YOU... THOUGH THERE'S SOMETHING YOU SHOULD KNOW...";

class IntroPageSeven extends StatefulWidget {
  const IntroPageSeven({super.key});

  @override
  State<IntroPageSeven> createState() => _IntroPageSevenState();
}

class _IntroPageSevenState extends State<IntroPageSeven>
