...
const _fullText = "DO YOU HAVE PEOPLE AROUND YOU, BUT THEY'RE NOT READY TO LISTEN?";
        ...
        child: GestureDetector(
          ...
          child: SafeArea(
            ...
            children: [
              ...
              // ✨ FEATURE: Animated progress indicator dots (3 dots, page 2 active)
              Padding(
              ...
              // Show button after animation completes OR after timeout as fallback
              AnimatedBuilder(
                            ...
                            onTap: () {
                              ...
                              Future.delayed(const Duration(milliseconds: 100), () {
                                if (mounted) {
                                  ...
                                  // ✨ NAVIGATION: Navigate to third page
                                  navigator.pushNamed('/onboard3');
                                }
                              });
                            },
                            child: Container(
